...
import { electromagnetismContent } from '../data/electromagnetism';
import { ArrowLeft, ChevronRight, Zap, Clock, Users, BookOpen } from 'lucide-react';

const ElectromagnetismContents: React.FC = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-slate-50 to-zinc-50 dark:from-gray-950 dark:via-slate-900 dark:to-gray-900">
      <div className="px-4 py-12 mx-auto max-w-6xl">
          ...
          <div className="flex flex-col mb-12 md:flex-row md:items-center md:space-x-8">
            ...
            <div>
              <h1 className="mt-4 mb-4 text-4xl font-bold text-gray-900 dark:text-white md:mt-0">
                {electromagnetismContent.title}
              </h1>
              <p className="max-w-3xl text-lg leading-relaxed text-gray-600 dark:text-gray-300">
                {electromagnetismContent.introduction.mainDescription}
              </p>
            </div>
          </div>
            ...
            <div className="p-6 bg-white rounded-xl shadow-md transition-shadow duration-200 dark:bg-gray-800 hover:shadow-lg">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-gray-900 dark:text-white">18th-19th Century</p>
                </div>
              </div>
            </div>
            <div className="p-6 bg-white rounded-xl shadow-md transition-shadow duration-200 dark:bg-gray-800 hover:shadow-lg">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-gray-900 dark:text-white">Maxwell, Faraday</p>
                </div>
              </div>
            </div>
            <div className="p-6 bg-white rounded-xl shadow-md transition-shadow duration-200 dark:bg-gray-800 hover:shadow-lg">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-gray-900 dark:text-white">{electromagnetismContent.sections.length}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          {electromagnetismContent.sections.map((section) => (
            <div 
              key={section.id} 
              ...
              >
                <div className="px-8 py-6 space-y-4">
                  {section.subsections.map((subsection) => (
                    <Link
                      key={subsection.id}
                      to={`/electromagnetism/${section.id}/${subsection.id}`}
                      className="block p-4 -mx-4 text-gray-600 transition-colors rounded-lg hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-700/50"
                    >
...
export default ElectromagnetismContents;
