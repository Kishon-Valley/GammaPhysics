...
import { ArrowLeft, ChevronRight, Zap, Clock, Users, BookOpen } from 'lucide-react';

const LightContents: React.FC = () => {
  const [expandedSection, setExpandedSection] = useState<string | null>(null);

  const introduction = {
    mainDescription: "Explore the fascinating world of light, from its dual nature as both wave and particle to its applications in modern technology. Understanding light has revolutionized our comprehension of the universe and enabled countless technological innovations."
  };
  ...
  const sections = [
    {
      ...
      subsections: [
        { id: "wave-particle", title: "1.1 Wave-Particle Duality" },
        { id: "historical-models", title: "1.2 Historical Models of Light" },
        { id: "em-spectrum", title: "1.3 Electromagnetic Spectrum" }
      ]
    },
    {
      id: "geometrical",
      title: "2. Geometrical Optics",
      subsections: [
        { id: "reflection-refraction", title: "2.1 Reflection and Refraction" },
      
        { id: "mirrors-lenses", title: "2.2 Mirrors and Lenses" },
        { id: "optical-instruments", title: "2.3 Optical Instruments" }
      ]
    },
    {
      id: "physical",
      title: "3. Physical Optics",
      subsections: [
        { id: "interference", title: "3.1 Interference" },
        { id: "diffraction", title: "3.2 Diffraction and Huygens' Principle" },
        { id: "polarization", title: "3.3 Polarization of Light" },
        { id: "coherence", title: "3.4 Coherence and Applications" }
      ]
    },
    {
      id: "quantum",
      title: "4. Quantum Nature of Light",
      subsections: [
        { id: "photoelectric", title: "4.1 Photoelectric Effect" },
        { id: "planck", title: "4.2 Planck's Quantum Hypothesis" },
        { id: "photons", title: "4.3 Photons and Energy Quantization" },
        { id: "modern-applications", title: "4.4 Applications in Modern Physics" }
      ]
    },
    {
      id: "interaction",
      title: "5. Light and Matter Interaction",
      subsections: [
        { id: "basic-interactions", title: "5.1 Absorption, Reflection, Transmission" },
        { id: "scattering", title: "5.2 Scattering Phenomena" },
        { id: "optical-properties", title: "5.3 Optical Properties of Materials" }
      ]
    },
    {
      id: "relativity",
      title: "6. Relativity and Light",
      subsections: [
        { id: "speed", title: "6.1 Speed of Light in Vacuum" },
        { id: "michelson-morley", title: "6.2 Michelson-Morley Experiment" },
        { id: "special-relativity", title: "6.3 Special Relativity" }
      ]
    },
    {
      id: "applications",
      title: "7. Applications of Light in Technology",
      subsections: [
        { id: "fiber-optics", title: "7.1 Fiber Optics and Communication" },
        { id: "laser-tech", title: "7.2 Laser Technology" },
        { id: "photonics", title: "7.3 Photonics and Optical Computing" },
        { id: "spectroscopy", title: "7.4 Spectroscopy" }
      ]
    }
  ];
            ...
            <div className="p-6 bg-white rounded-xl shadow-md transition-shadow duration-200 dark:bg-gray-800 hover:shadow-lg">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-gray-900 dark:text-white">Newton, Einstein, Maxwell</p>
                </div>
              </div>
            </div>
            <div className="p-6 bg-white rounded-xl shadow-md transition-shadow duration-200 dark:bg-gray-800 hover:shadow-lg">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-gray-900 dark:text-white">{sections.length}</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className={`${
                ...
                <div className="px-8 pb-6 space-y-2">
                  {section.subsections.map((subsection) => (
                    <Link
                      key={subsection.id}
                      to={`/light/${section.id}/${subsection.id}`}
